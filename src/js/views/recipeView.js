...
class ViewRecipe extends View {
  ...
  _generateMarkup() {
    ...
    <div class="recipe__ingredients">
      ...
      <h3 class="total__calories">
        Total Calories: 
          <span class="total__calories-text">
            ${Intl.NumberFormat('en-US').format(
              +this._data.ingredients
                .filter(ing => Number.isFinite(ing.calories))
                .reduce((acc, ing2) => (acc += ing2.calories), 0)
                .toFixed(2)
            )}
          </span> 
      </h3>
      ...
      ${this._data.ingredients
        .map(ing => this._renderIngrediantsMarkup(ing))
        .join('')}
      </ul>
    </div>
  ...
  _renderIngrediantsMarkup(ing) {
    ...
    <div class="recipe__description">
      ...
      <div class="recipe__calories">
        Calories: ${Intl.NumberFormat('en-US').format(ing.calories)}
      </div>
            `
          : ''
      }
